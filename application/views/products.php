    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 img-portfolio">
                ...
                <h3>
                    <a href="portfolio-item.html">Self Aligning Frames</a>
                </h3>
              <!--  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p> -->
            </div>
            <div class="col-md-4 img-portfolio">
                ...
                <h3>
                    <a href="portfolio-item.html">Conveyor Roller Frame</a>
                </h3>
               <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p> -->
            </div>
            <div class="col-md-4 img-portfolio">
        ...
        <div class="col-md-4 img-portfolio">
                <a href="portfolio-item.html">
                    <img class="img-responsive img-hover"  src="<?php echo base_url(); ?>superman.jpg" alt="Mountains">
             </a>
              <h3>
                    <a href="portfolio-item.html">Project Name</a>
                </h3>
