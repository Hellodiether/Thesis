...
<textarea name="field3" placeholder="Something you want to add"  style="width:100%; height: 50px;"></textarea>
</fieldset>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    <img class="img-responsive" src="<?php echo base_url(); ?>images/aj.jpg" alt="">
                    <div class="caption">
