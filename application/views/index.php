...
<div class="form-group">
                <select class="form-control select2" name="services[]" multiple="multiple" data-placeholder="Select a State"
                        style="width: 100%;">
                  <option>Conveyor Rollers</option>
                  <option>Conveyor Pulley</option>
                  <option>Cylinder Mould</option>
                  <option>Beam Mould</option>
                  <option>Belt Conveyor Pulley</option>
                  <option>Self Aligning Frames</option>
                  <option>Conveyor Roller Frames</option>
                  <option>Anchor Bolt</option>
                  <option>Stud Bolt</option>
                </select>
              </div>   
</fieldset>
<fieldset>
...
<input type="submit" value="Add" />
    ...
    <div class="container">
        ...
        <div class="well">
            <div class="row">
                <div class="col-md-8">
                    <p>Click the butto to download our Company Profile!
                    </p>
                </div>
                <div class="col-md-4">
                  
                    <a class="btn btn-lg btn-default btn-block" href="<?php echo base_url(); ?>TDY (Company Profile).pdf" download>Download</a>    
                </div>
            </div>
        </div>
